...
import azureML from "@/app/logo/azure-ml.svg";
import azure from "@/app/logo/azure.svg";
import github from "@/app/logo/github.svg";
import next from "@/app/logo/next.svg";
      ...
      <div className="font-inter relative flex min-h-[100vh] w-screen flex-col overflow-hidden bg-[#F2F3F5] sm:min-h-screen">
        ...
        <main className="static z-[100] flex h-[90%] w-screen grid-rows-[1fr_repeat(3,auto)_1fr] flex-col justify-center overflow-hidden px-4 pb-[320px] pt-[30px] md:fixed md:px-20 md:py-0">
          ...
          <motion.h1
            ...
            className="font-inter relative z-[100] text-[16vw] font-extrabold leading-[0.9] tracking-[-2px] text-[#1E2B3A] md:mb-[37px] md:ml-[-10px] md:text-[96px]"
          >
            Charging in sync
            <br />
            <svg
              ...
              className="-mx-6 -my-3 inline-block h-[7rem] w-[7rem] -rotate-90 p-0 align-baseline"
            >
              <rect
                width="16"
                height="10"
              ...
              <mask id="text">
                ...
                <text
                  ...
                  fill="black"
                  stroke="none"
                  className="font-inter text-[5px] font-semibold"
                  textLength={8}
                >
                  with
                </text>
            ...
            nature&apos;s{" "}
            <span className="bg-gradient-to-r from-pallete-3 to-pallete-1 bg-clip-text text-transparent">
              rhythm
            </span>
            <span className="font-inter text-pallete-1">.</span>
          </motion.h1>
          <motion.div
            initial={{ opacity: 0, y: 40 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <motion.canvas
          ...
          id="gradient-canvas"
          data-transition-in
          className="fixed right-[-2px] top-0 z-50 h-screen w-[80%] bg-pallete-3 md:w-1/2"
        ></motion.canvas>
        <div className="fixed bottom-0 z-20 flex h-[60px] w-full flex-row items-center justify-evenly bg-[#1D2B3A]">
          ...
          <strong className="font-inter text-base text-white/80 md:text-lg md:leading-[60px]">
            AI
          </strong>
          <Image
            src={azure}
            alt="azure"
            className="mt-[6px] w-[40px] text-white opacity-80 grayscale"
          />
          <Image
            src={azureML}
            alt="azure"
            className="mt-[6px] w-[75px] text-white opacity-80 grayscale"
          />
          <Image
            src={next}
            alt="azure"
          ...
          <Image
            src={github}
            alt="azure"
            className="mt-[6px] w-[95px] text-white opacity-80 grayscale"
          />
          <svg
          ...
          <svg
            className="mt-[6px] w-[70px] text-white opacity-80"
            viewBox="0 0 603 182"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            className="hidden w-[80px] text-white opacity-80 md:block"
            viewBox="0 0 55 15"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            className="hidden w-[80px] text-white opacity-80 lg:block"
            viewBox="0 0 291 80"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            className="hidden w-[100px] text-white opacity-80 md:block"
          ...
          <svg
            className="hidden w-[50px] text-white opacity-80 lg:block"
            viewBox="0 0 927 322"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
          ...
          <svg
            className="hidden w-[60px] text-white opacity-80 lg:block"
            viewBox="0 0 700 295"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
